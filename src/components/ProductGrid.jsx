...
// // --- New Price Range Slider Component ---
// const PriceRangeSlider = ({ min, max, step, price, setPrice }) => {
...
//   // Update parent state
//   useEffect(() => {
//     setPrice({ min: minVal, max: maxVal });
...
//         <div className="relative w-full h-1  rounded-md">
...
//     green: 'bg-green-400', orange: 'bg-orange-400', white: 'bg-gray-200 border border-gray-300',
//     yellow: 'bg-yellow-400', multicolor: 'bg-gradient-to-r from-pink-400 to-yellow-400',
//     rainbow: 'bg-gradient-to-r from-red-400 via-green-400 to-blue-400',
//     navy: 'bg-blue-900', red: 'bg-red-500', gold: 'bg-yellow-500',
//     silver: 'bg-gray-400', brown: 'bg-yellow-800', black: 'bg-black',
//   };
...
//   const sidebarVariants = { visible: { x: 0 }, hidden: { x: '100%' } };
...
//             className="fixed top-0 right-0 h-full w-full max-w-sm bg-white dark:bg-gray-800 shadow-xl z-50 flex flex-col"
//           >
...
//                   step={100}
//                   price={filters.price}
//                   setPrice={(newPrice) => setFilters(prev => ({ ...prev, price: newPrice }))}
//                 />
//               </div>

//               {/* --- Colors --- */}
//               <div>
//                 <h4 className="font-semibold mb-3 text-gray-700 dark:text-gray-200">Colors</h4>
//                 <div className="flex flex-wrap gap-3">
//                   {uniqueColors.map(color => (
//                     <button
//                       key={color}
//                       onClick={() => handleColorSelect(color)}
//                       className={`w-8 h-8 rounded-full capitalize transition-transform duration-200 hover:scale-110 ${colorMap[color] || 'bg-gray-300'} ${filters.color === color ? 'ring-2 ring-offset-2 dark:ring-offset-gray-800 ring-pink-500' : ''}`}
...
//               {/* --- Sizes --- */}
//               <div>
//                 <h4 className="font-semibold mb-3 text-gray-700 dark:text-gray-200">Sizes</h4>
//                 <div className="flex flex-wrap gap-2">
//                   {AVAILABLE_SIZES.map(size => (
//                     <button
//                       key={size}
//                       onClick={() => handleSizeToggle(size)}
//                       className={`px-4 py-2 border rounded-lg font-medium transition-colors duration-200 ${filters.sizes.includes(size) ? 'bg-pink-500 text-white border-pink-500' : 'bg-transparent hover:bg-gray-100 dark:hover:bg-gray-700 dark:border-gray-600'}`}
//                     >
//                       {size}
//                     </button>
//                   ))}
...
//               <Button onClick={onClose} className="w-full py-3 bg-pink-500 text-white rounded-xl hover:bg-pink-600">Apply</Button>
//             </div>
//           </motion.div>
//         </>
//       )}
...
//     { id: '1', name: 'Rainbow Unicorn Dress', image: 'https://images.unsplash.com/photo-1560359601-01c9c800ee60?w=600', originalPrice: 1599, discountedPrice: 1199, discount: 25, rating: 4.8, reviews: 156, colors: ['pink', 'purple', 'blue'], sizes: ['S', 'M', 'L'], category: 'Girls', isNew: true, isBestseller: true },
//     { id: '2', name: 'Cool Dino T-Shirt Set', image: 'https://images.unsplash.com/photo-1585528761181-2865fc48723f?w=600', originalPrice: 1299, discountedPrice: 999, discount: 23, rating: 4.6, reviews: 89, colors: ['green', 'blue', 'orange'], sizes: ['XS', 'S', 'M'], category: 'Boys', isBestseller: true },
//     { id: '3', name: 'Cute Baby Onesie', image: 'https://images.unsplash.com/photo-1545877872-3e6582cbc37c?w=600', originalPrice: 799, discountedPrice: 639, discount: 20, rating: 4.9, reviews: 234, colors: ['white', 'pink', 'yellow'], sizes: ['XS'], category: 'Infants', isNew: true },
//     { id: '4', name: 'Colorful Sneakers', image: 'https://images.unsplash.com/photo-1669762162480-fb67378e307b?w=600', originalPrice: 2199, discountedPrice: 1539, discount: 30, rating: 4.7, reviews: 67, colors: ['multicolor', 'rainbow', 'black'], sizes: ['M', 'L'], category: 'Accessories' },
//     { id: '5', name: 'Winter Cozy Jacket', image: 'https://images.unsplash.com/photo-1513978121979-75bfaa6a713b?w=600', originalPrice: 2499, discountedPrice: 1749, discount: 30, rating: 4.9, reviews: 145, colors: ['navy', 'red', 'green'], sizes: ['M', 'L', 'XL'], category: 'Outerwear', isBestseller: true },
//     { id: '6', name: 'Party Princess Dress', image: 'https://images.unsplash.com/photo-1694083884221-d23d8b1a83b5?w=600', originalPrice: 1899, discountedPrice: 1329, discount: 30, rating: 4.8, reviews: 201, colors: ['gold', 'silver', 'purple'], sizes: ['S', 'M'], category: 'Girls', isNew: true },
//     { id: '7', name: 'Comfy Corduroy Set', image: 'https://images.unsplash.com/photo-1618511867134-2e7b5b5832ee?w=600', originalPrice: 1799, discountedPrice: 1439, discount: 20, rating: 4.7, reviews: 95, colors: ['brown', 'green', 'blue'], sizes: ['L', 'XL'], category: 'Cord Sets' },
//     { id: '8', name: 'Breezy Culotte Set', image: 'https://images.unsplash.com/photo-1593431632344-f73244d66b59?w=600', originalPrice: 1399, discountedPrice: 1049, discount: 25, rating: 4.6, reviews: 78, colors: ['yellow', 'white', 'blue'], sizes: ['S', 'M', 'L'], category: 'Culotte Sets' },
//   ];
...
//               className="inline-flex items-center justify-center min-w-[200px] rounded-full border border-gray-300 dark:border-gray-600 shadow-sm px-6 py-3 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
//             >
...
//                       <a key={category} href="#" onClick={(e) => { e.preventDefault(); handleCategorySelect(category); }}
...
//             className="flex items-center gap-2 rounded-full border border-gray-300 dark:border-gray-600 shadow-sm px-6 py-3 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
//           >
...
//                             <Button onClick={() => onAddToCart(product)} className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white rounded-xl py-3 font-medium flex items-center justify-center">
...
export const ProductGrid = ({ products = [], onProductClick = () => {}, onAddToCart = () => {}, onAddToWishlist = () => {} }) => {
  ...
  const defaultFilters = useMemo(() => ({
    price: { min: 500, max: 3000 }, color: null, sizes: [],
  }), []);
