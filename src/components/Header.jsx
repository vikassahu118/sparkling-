...
export function Header({ 
  ...
  return (
    <>
      ...
      >
        <div className="secure-container mx-auto px-safe-area-inset-x py-3">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="hidden sm:block">
                <motion.h1 
                  className={`text-responsive-xl lg:text-responsive-2xl font-bold bg-gradient-to-r ${getTextGradient()} bg-clip-text text-transparent`}
                  animate={{
                ...
                <p className={`text-responsive-xs ${isDarkMode ? 'text-purple-300' : 'text-gray-500'} transition-colors duration-500`}>
            ...
            <nav className="hidden lg:flex items-center space-x-2">
              {navItems.map((item) => (
                ...
                >
                  ...
                  >
                    <span className="flex items-center gap-2 text-responsive-sm font-medium">
                      <span className="text-responsive-base">{item.emoji}</span>
                      {item.label}
                    </span>
                    {currentView !== item.id && (
                      <motion.div
            ...
            <div className="flex items-center space-x-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className={`lg:hidden p-2 rounded-xl ${getActionButtonBg()} backdrop-blur-md shadow-lg touch-optimized transition-all duration-500 mobile-nav-button`}
              >
                <motion.div
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <div className="secure-container mx-auto mobile-container py-4">
              <div className="grid grid-cols-2 gap-3">
                {navItems.map((item, index) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`p-4 rounded-2xl text-left transition-all duration-500 touch-optimized mobile-card ${
                      currentView === item.id
                        ? isDarkMode 
                          ? 'bg-gradient-to-r from-purple-500 to-cyan-500 text-white shadow-lg' 
                          : 'bg-gradient-to-r from-pink-400 to-purple-500 text-white shadow-lg'
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-responsive-xl">{item.emoji}</span>
                      <div>
